...
from profiles.views import UserProfileForm
...
def checkout(request):
    ...
    if request.method == 'POST':
                    ...
                    if isinstance(item_data, int):
                        ...
                        for selected_flavor, quantity in item_data['product_by_flavor'].items():
                            order_line_item = OrderLineItem(
                                ...
                                product=product,
                                quantity=quantity,
                                product_flavor=selected_flavor
                            )
                            order_line_item.save()
        ...
        checkout_total = current_cart['grand_total']
        ...
        if not stripe_public_key:
            messages.warning(request, 'Stripe public key is missing. \
                Check if the Stripe public key in the environment.')
